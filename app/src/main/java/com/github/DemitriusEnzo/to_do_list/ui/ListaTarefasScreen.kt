...
import com.github.DemitriusEnzo.to_do_list.util.formatarDataHora
import com.github.DemitriusEnzo.to_do_list.viewmodel.TarefaViewModel
...
private fun ConfirmacaoExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = { Text("A tarefa \"${tarefa.titulo}\" será excluída definitivamente.") },
        dismissButton = {
    ...
    Card(
        ...
        Row(
            ...
            IconButton(onClick = onDeletar) {
                Icon(Icons.Default.Delete, contentDescription = "Excluir ${tarefa.titulo}")
            }
        }
    }
}
...
@Preview(showBackground = true, name = "Confirmar exclusão")
@Composable
private fun ConfirmacaoExclusaoPreview() {
    ConfirmacaoExclusaoDialog(
        tarefa = Tarefa(id = 1, titulo = "Estudar Room", descricao = "Revisar anotações"),
        onCancelar = {},
        onConfirmar = {}
    )
}
